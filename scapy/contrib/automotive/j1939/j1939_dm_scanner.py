...
+-------+--------+-------------------------------------------+
| DM3   | 65228  | DTC Clear/Reset for Previously Active DTCs|
+-------+--------+-------------------------------------------+
...
+-------+--------+-------------------------------------------+
| DM11  | 65235  | DTC Clear/Reset for Active DTCs           |
+-------+--------+-------------------------------------------+
| DM12  | 65236  | Emission-Related Active DTCs              |
+-------+--------+-------------------------------------------+
